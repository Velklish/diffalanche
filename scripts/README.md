...
| `bundle.ts` | The npm bundle, `dist/cli.js` and `dist/embed-child.js`, with the runtime's binding loaded from the user cache (`bun run build:cli`); see [reference/09-ml.md](../docs/reference/09-ml.md#delivery) |
