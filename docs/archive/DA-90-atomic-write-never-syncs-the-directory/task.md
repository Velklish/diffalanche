...
- The lock's own timing defects, filed as [DA-89](../DA-89-stale-lock-outlives-the-wait/task.md) and
  [DA-78](../DA-78-lock-release-is-not-atomic/task.md); this entry touches lock.ts:109 only if the decision
