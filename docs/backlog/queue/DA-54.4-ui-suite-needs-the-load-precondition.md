...
- **Created:** 2026-09-21
- **Cost:** major
- **Dependencies:** [DA-54.5](DA-54.5-load-precondition-reads-one-minute-only.md) — its last question is whether the precondition belongs to `perf` alone or to the gate list, and this entry is the first caller of that answer
