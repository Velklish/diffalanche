...
- [DA-76.4](../minor/DA-76.4-parse-diff-may-cost-ten-ms-on-the-rescan-path.md) — a performance hypothesis; it needs a quiet machine and goes with the perf pass.
- 08-ui entries: [DA-113](DA-113-ui-minors-56-2-76-2.md).
