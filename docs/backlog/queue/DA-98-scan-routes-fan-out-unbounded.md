...
- Whether the perf gate should grow a line for the scan routes at all: what the gate measures and what it silently passes is [DA-69](DA-69-perf-gate-reports-green-unmeasured.md).
