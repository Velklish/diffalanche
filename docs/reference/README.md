...
|---|---|---|
| 01-scanner.md | Finding repositories under the root: roots, depth, exclude, worktrees, warnings | `src/core/scanner` |
| 02-git.md | Reading the change set: base modes, merge base, untracked files, patch parsing | `src/core/git` |
...
| 06-cli.md | Commands, flags, exit codes, JSON output | `src/cli` |
| 07-server.md | HTTP routes, the review bundle, SSE stream, static UI | `src/server` |
